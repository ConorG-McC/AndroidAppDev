package com.example.androidappdev.data.auth
...
class AuthRepository(private val auth: FirebaseAuth) : AuthRepo {
    ...
    override suspend fun firebaseSignUpWithEmailAndPassword(email: String,
                                                            password: String
    ): SignUpResponse {
        return try {
    ...
    override suspend fun firebaseSignInWithEmailAndPassword(email: String,
                                                            password: String
    ): SignInResponse {
        return try {
